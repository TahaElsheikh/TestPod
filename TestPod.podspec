...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Taha Elsheikh"
  # s.authors            = { "Taha Elsheikh" => "tahaabdelraoof22@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Taha Elsheikh"
...
#s.source       = { :git => "https://github.com/TahaElsheikh/TestPod.git", :tag => "#{s.version}" }
  ...
  #
    ...
    s.source_files      = "TestPod/*.{m,h}", "AnotherFolder/*.{m,h}"
    s.requires_arc      = true
